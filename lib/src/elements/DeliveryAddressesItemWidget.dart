            ...
            if (paymentMethod != null)...{
              Stack(
                ...
                children: <Widget>[
                  ...
                  Container(
                    height: (paymentMethod?.selected ?? false) ? 60 : 0,
                    width: (paymentMethod?.selected ?? false) ? 60 : 0,
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.all(Radius.circular(8)),
                      color: Theme.of(context).accentColor.withOpacity(this.paymentMethod!.selected! ? 0.74 : 0),
                    ),
                    child: Icon(
                      Icons.check,
                      size: (paymentMethod?.selected ?? false) ? 44 : 0,
                      color: Theme.of(context).primaryColor.withOpacity((paymentMethod?.selected ?? false) ? 0.9 : 0),
                    ),
                  ),
                  // Container(
                  //   height: 60,
