...
class DeliveryAddressDialog {
  ...
  DeliveryAddressDialog({required this.context, this.address, this.onChanged}) {
    showDialog(
        context: context,
        builder: (context) {
          return SimpleDialog(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child:  TextFormField(
                        ...
                        validator: (input) => input!.trim().isEmpty ? 'Not valid address' : null,
