                  ...
                  Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        if ( widget.user!.email == null ||  widget.user!.email  == "")...{
                           TextFormField(
                            style: TextStyle(color: Theme.of(context).hintColor),
                            keyboardType: TextInputType.emailAddress,
                            decoration: getInputDecoration(hintText: 'johndo@gmail.com', labelText: S.of(context)!.email_address),
                            initialValue: widget.user!.email,
                            validator: (input) => (!input!.contains('@') && (!input.isEmpty)) ? S.of(context)!.not_a_valid_email : null,
                         ...
                         TextFormField(
                          ...
                          decoration: getInputDecoration(hintText: '05xxxxxxxx', labelText: S.of(context)!.phone),
