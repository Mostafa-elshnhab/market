    ...
    return Drawer(
      child: ListView(
        children: <Widget>[
            ...
            child: currentUser.value.apiToken != null
                ? UserAccountsDrawerHeader(
                    ...
                    currentAccountPicture: CircleAvatar(
                      ...
                      "${currentUser.value.name!.toUpperCase().substring(0,1)}":"L",style:  TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          ListTile(
            onTap: () {
              launch("https://sites.google.com/view/steeramarket/%D8%A7%D9%84%D8%B5%D9%81%D8%AD%D8%A9-%D8%A7%D9%84%D8%B1%D8%A6%D9%8A%D8%B3%D9%8A%D8%A9");
            },
            leading: Icon(
              Icons.security,
              color: Theme.of(context).focusColor.withOpacity(1),
