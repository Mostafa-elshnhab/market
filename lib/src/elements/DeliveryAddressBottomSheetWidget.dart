          ...
          Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: () async {
                   await _con!.changeDeliveryAddressToCurrentLocation().then((value1) {
                    });
                    if (_con!.currentAd != null) {
                      showDialog(
                          context: context,
                          builder: (context) {
                            return SimpleDialog(
                                    ...
                                    MaterialButton(
                                      onPressed: () {
                                        _con!.addAddress( Address.fromJSON({
                                          'address':
                                              "(${_con!.tempAddress})\n" +
                                                  _con!.currentAd!.address!,
                                          'latitude': _con!.currentAd!.latitude!,
                                          'longitude':
                                              _con!.currentAd!.longitude!,
                                        }));
                                        _con!.tempAddress = "";
                                        Navigator.pop(context);
                                        Navigator.of(widget.scaffoldKey!.currentContext!).pop();
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Text("${_con!.addresses![index].address}")
                                      // Text(
