...
// import 'package:markets/src/helpers/app_config.dart';
...
//  SettingsWidget({Key? key,required this.context}) : super(key: key);
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                              ...
                              child: InkWell(
                                ...
                                child: CircleAvatar(
                                  child: Text((currentUser.value != null && currentUser.value.name  != null &&currentUser.value.name!.length > 2) ?
                                    "${currentUser.value.name!.toUpperCase().substring(0,1)}":"",style: new TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            ...
                            trailing: (currentUser.value.phone == null || currentUser.value.phone == "" ) ?
                            Text(
                    ...
                    // ),
                    _con!.isLoading
                        ? CircularLoadingWidget(height: 50):Text(""),
                    Container(
                      margin: EdgeInsets.symmetric(horizontal: 20, vertical: 15),
                      decoration: BoxDecoration(
                        color: Theme.of(context).primaryColor,
