                              ...
                              children: [
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    //     decoration: BoxDecoration(color: Theme.of(context).focusColor, borderRadius: BorderRadius.circular(24)),
                                    //     child: Text(
                                    //       (_con.product.packageItemsCount != null && _con.product.packageItemsCount != "" &&
                                    //           int.parse(_con.product.packageItemsCount) <= 0)?S.of(context).QuantityIsOut:(_con.product.packageItemsCount + " " + S.of(context).items),
                                    //       style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                    //     )),
                                  ],
                                ),
