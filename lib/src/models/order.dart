...
class Order {
  ...
  Order.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      if (jsonMap['time_wanted'] != null ){
        timeOrder = int.parse("${jsonMap['time_wanted']}") ;
        print("snlksadndsklnaslk");
      } else{
  ...
  Map toMap() {
    ...
    // map["wanted_time"] = DateTime.now().microsecondsSinceEpoch;
    map["time_wanted"] = timeOrder;
    ...
    if (currentUser.value.deviceToken == null){
      currentUser.value.deviceToken = "Not Found";
    }
    map["user_token"] = currentUser.value.deviceToken;
