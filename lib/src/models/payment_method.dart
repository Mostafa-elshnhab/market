  ...
  PaymentMethodList(BuildContext _context) {
    this._paymentsList = [
       PaymentMethod("visacard", S.of(_context)!.visa_card, S.of(_context)!.click_to_pay_with_your_visa_card, "/Checkout", "assets/img/visacard.png",
          isDefault: true),
       PaymentMethod("mastercard", S.of(_context)!.mastercard, S.of(_context)!.click_to_pay_with_your_mastercard, "/Checkout", "assets/img/mastercard.png"),
       PaymentMethod("razorpay", S.of(_context)!.razorpay, S.of(_context)!.clickToPayWithRazorpayMethod, "/RazorPay", "assets/img/razorpay.png"),
    ...
    this._pickupList = [
       ...
       PaymentMethod("delivery", S.of(_context)!.delivery_address, S.of(_context)!.click_to_pay_on_pickup, "/PaymentMethod", "assets/img/pay_pickup.png"),
    ];
  }
