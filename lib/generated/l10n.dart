...
class S {
  ...
  /// `Please select a address if it does not exist`
  String get deliveryMsgNotAllowed {
    return Intl.message(
      'Please select a address if it does not exist',
      name: 'deliveryMsgNotAllowed',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You do not have an account with this number`
  String get dont_account_phone {
    return Intl.message(
      'You do not have an account with this number',
      name: 'dont_account_phone',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please enter your phone number and a confirmation code message will be sent to be able to register`
  ...
  /// `Quantity is out of stock and will be available soon`
  String get QuantityIsOut {
    return Intl.message(
      'Quantity is out of stock and will be available soon',
      name: 'QuantityIsOut',
      desc: '',
  ...
  /// `It is not possible to purchase a large number of  this product in the same order`
  String get Notpossible_product {
    return Intl.message(
      'It is not possible to purchase a large number of  this product in the same order',
      name: 'Notpossible_product',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please click on the address and choose a delivery address`
  String get Please_address {
    return Intl.message(
      'Please click on the address and choose a delivery address',
      name: 'Please_address',
      desc: '',
