...
import 'package:market/src/pages/login_phone.dart';
import 'package:market/src/pages/mobile_verification_2.dart';
import 'package:market/src/pages/subcategories.dart';
    ...
    switch (settings.name) {
      ...
      case '/MobileVerification2':
        return MaterialPageRoute(
            builder: (_) =>
                MobileVerification2(routeArgument: args as RouteArgument));
      case '/Login':
        return MaterialPageRoute(builder: (_) => LoginWidget());
      case '/LoginPhone':
        return MaterialPageRoute(builder: (_) => LoginPhoneWidget());
      case '/Profile':
      ...
      case '/SubcategoriesWidget':
        return MaterialPageRoute(builder: (_) => SubcategoriesWidget(routeArgument: args as RouteArgument));
      case '/Cart':
